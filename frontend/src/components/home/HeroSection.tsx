  ...
  return (
    <section className="relative min-h-[90vh] flex flex-col items-center justify-center px-4 pt-24 pb-16 overflow-x-hidden">
      ...
      <motion.h1
        ...
        className="font-display text-2xl sm:text-3xl md:text-5xl font-bold text-text-primary tracking-wider text-center mt-10 max-w-full px-2"
      >
      ...
      <motion.div
        ...
        className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 mt-8 font-mono text-sm text-text-muted"
      >
        <span>
